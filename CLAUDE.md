...
|---|---|---|
| **Sirium** (marque **produit** : le cocktail) vs **SYFIR** (l'**écosystème** et la marque mère : univers, événementiel, billetterie, média) | l'ancien nom du produit, abandonné en R49 · **aucun diminutif** « Syp » ni « Syf » en communication officielle | Amendement R49/R50 (loi Évin, séparation produit / marque mère, validée par le fondateur) : le PRODUIT alcoolisé est **Sirium** (variante « Planteur ») ; **SYFIR** reste l'univers, l'événement, la billetterie et le média. Règle : **jamais de diminutif** (« Syp », « Syf ») là où le message est contrôlé. Les cocktails se nomment **Sirium Planteur / Coral Breeze / Golden Escape** ; `brand` JSON-LD des objets `Product` = `Sirium`. Ne touche pas à **SYFIR** (univers/nav/footer/logo/#brand) ni à « Le Cocktail Libre ». |
...
| **Nos Signatures** (la vitrine saveurs de l'accueil) | ~~Nos Cocktails Signature~~ | Amendement R12 : le titre de la section cartes pochettes de l'accueil (accent Fraunces sur *Signatures*). Ne renomme ni la page `saveurs.html`, ni la row du méga-menu (« Les pochettes **Sirium** »). |
| **Sirium cocktail** (l'entrée de nav vers `saveurs.html`) | ~~Saveurs~~, ~~Notre Gamme~~ · les anciens libellés de la vitrine (abandonnés R49/R50) | Amendement R19/R49/R50 : **Sirium cocktail** est un **libellé autonome** (item de nav, `title`/`og:title`, h1 du hero, fin de fil d'Ariane) ; en nav (capitales via CSS) s'affiche **SIRIUM COCKTAIL**. Dans une phrase **avec article**, écrire « **la collection Sirium** » ou « **nos cocktails Sirium** » — ne jamais accoler « Sirium cocktail » à un article défini. L'URL reste `saveurs.html` ; hero aligné (eyebrow « La collection », h1 « Sirium *cocktail* », title/og « Sirium cocktail »). |
| **Panneau Sirium cocktail** — 3 entrées catégories | ~~liste de produits~~ | Amendement R15/R19 : le déroulant de nav est un panneau pleine largeur (vignettes + libellés capitales) à trois catégories : **Toute la collection** (`saveurs.html`), **Nos cocktails** (`saveurs.html#cocktails`, la grille — expérience « sur place, dans le verre ») et **Nos signatures** (`saveurs.html#signatures`, la pochette signature — expérience « à emporter »). Pas de noms de produits individuels dans la nav. |
